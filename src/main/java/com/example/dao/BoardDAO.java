...
public class BoardDAO {
	...
	private final String BOARD_INSERT = "insert into BOARD (category, title, photo, writer, content) values (?,?,?,?,?)";
	private final String BOARD_UPDATE = "update BOARD set category=?, title=?, photo=?, writer=?, content=? where seq=?";
